      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        ...
        <div className="pt-12 sm:pt-20 md:pt-30 text-center">
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6 sm:mb-8 leading-tight px-2">
            Send Certificates & Event Tickets
            <span className="block mt-2 text-2xl sm:text-3xl md:text-4xl" style={{ color: '#b298dc' }}>Directly from Your Email</span>
          </h1>
          
          <p className="text-gray-300 text-base sm:text-lg md:text-xl mb-8 sm:mb-12 max-w-3xl mx-auto leading-relaxed px-4">
            Create and send professional certificates, participation mails, and event tickets seamlessly. 
            Import data from spreadsheets and send personalized emails directly from your own email account. 
            Perfect for events, courses, workshops, and achievements.
          </p>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-6 mb-12 sm:mb-20 px-4">
            ...
            <button className="w-full sm:w-auto px-8 py-4 rounded-xl font-semibold text-base sm:text-lg text-white border-2 hover:bg-white hover:text-gray-900 transition-all duration-300" style={{ borderColor: 'rgba(179, 152, 220, 0.6)' }}>
              View Templates
            </button>
          </div>
        ...
        <div className="py-16 sm:py-20 md:py-24">
          <div className="text-center mb-12 sm:mb-16 px-4">
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-4 sm:mb-6 leading-tight">
              ...
              <span className="block mt-2" style={{ color: '#b298dc' }}>professional emails with attachments</span>
            </h2>
            <p className="text-gray-400 text-base sm:text-lg md:text-xl max-w-3xl mx-auto leading-relaxed">
              From certificate creation to event ticket delivery, our platform handles every step 
              of the email marketing process using your own email account for authentic communication.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 px-4">
            <div className="p-6 sm:p-8 rounded-3xl border backdrop-blur-sm transition-all duration-300 hover:scale-105 hover:shadow-xl" style={{ backgroundColor: 'rgba(24, 49, 79, 0.6)', borderColor: 'rgba(179, 152, 220, 0.3)' }}>
              ...
              <h3 className="text-white text-lg sm:text-xl font-semibold mb-3 sm:mb-4">Custom Certificates & Tickets</h3>
              <p className="text-gray-400 text-sm sm:text-base leading-relaxed">Design beautiful certificates, participation letters, and event tickets with our drag-and-drop editor. Multiple templates for every occasion.</p>
            </div>
            ...
            <div className="p-6 sm:p-8 rounded-3xl border backdrop-blur-sm transition-all duration-300 hover:scale-105 hover:shadow-xl" style={{ backgroundColor: 'rgba(24, 49, 79, 0.6)', borderColor: 'rgba(179, 152, 220, 0.3)' }}>
              ...
              <h3 className="text-white text-lg sm:text-xl font-semibold mb-3 sm:mb-4">Spreadsheet Integration</h3>
              <p className="text-gray-400 text-sm sm:text-base leading-relaxed">Import recipient data from Google Sheets and generate hundreds of personalized emails with attachments in seconds, not hours.</p>
            </div>
            ...
            <div className="p-6 sm:p-8 rounded-3xl border backdrop-blur-sm transition-all duration-300 hover:scale-105 hover:shadow-xl" style={{ backgroundColor: 'rgba(24, 49, 79, 0.6)', borderColor: 'rgba(179, 152, 220, 0.3)' }}>
              ...
              <h3 className="text-white text-lg sm:text-xl font-semibold mb-3 sm:mb-4">Your Email, Your Brand</h3>
              <p className="text-gray-400 text-sm sm:text-base leading-relaxed">Send emails directly from your own Gmail account. Recipients see your email address, maintaining trust and brand authenticity.</p>
            </div>
            ...
            <div className="p-6 sm:p-8 rounded-3xl border backdrop-blur-sm transition-all duration-300 hover:scale-105 hover:shadow-xl" style={{ backgroundColor: 'rgba(24, 49, 79, 0.6)', borderColor: 'rgba(179, 152, 220, 0.3)' }}>
              ...
              <h3 className="text-white text-lg sm:text-xl font-semibold mb-3 sm:mb-4">Event Management</h3>
              <p className="text-gray-400 text-sm sm:text-base leading-relaxed">Perfect for workshops, webinars, conferences, and courses. Send participation certificates, event tickets, and follow-up communications.</p>
            </div>
            ...
            <div className="p-6 sm:p-8 rounded-3xl border backdrop-blur-sm transition-all duration-300 hover:scale-105 hover:shadow-xl" style={{ backgroundColor: 'rgba(24, 49, 79, 0.6)', borderColor: 'rgba(179, 152, 220, 0.3)' }}>
              ...
              <h3 className="text-white text-lg sm:text-xl font-semibold mb-3 sm:mb-4">Email Analytics</h3>
              <p className="text-gray-400 text-sm sm:text-base leading-relaxed">Track email delivery, open rates, and recipient engagement. See which certificates were downloaded and tickets were accessed.</p>
            </div>
            ...
            <div className="p-6 sm:p-8 rounded-3xl border backdrop-blur-sm transition-all duration-300 hover:scale-105 hover:shadow-xl" style={{ backgroundColor: 'rgba(24, 49, 79, 0.6)', borderColor: 'rgba(179, 152, 220, 0.3)' }}>
              ...
              <h3 className="text-white text-lg sm:text-xl font-semibold mb-3 sm:mb-4">Gmail Integration</h3>
              <p className="text-gray-400 text-sm sm:text-base leading-relaxed">Seamlessly connect with your Gmail account. No third-party email services needed - everything works through your existing email.</p>
            </div>
          </div>
        </div>
      </div>
